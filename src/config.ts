...
export const MATRIX_BOT_USER_ID =
  process.env.MATRIX_BOT_USER_ID || envConfig.MATRIX_BOT_USER_ID || '';
...
export const CONTAINER_IMAGE =
  process.env.CONTAINER_IMAGE || 'ghcr.io/leovr/nanoclaw-agent:latest';
